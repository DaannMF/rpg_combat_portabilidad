...
public class PlayerAbilitySystem : IPlayerAbilitySystem {
    public List<PlayerAction> GetAvailableActions(BaseCharacter character, List<BaseCharacter> allCharacters) {
    ...
    private List<PlayerAction> GetPlayerActions(BaseCharacter character, List<BaseCharacter> allCharacters) {
    ...
    public bool CanPerformAction(BaseCharacter character, PlayerAction action) {
    ...
    public bool ExecuteAction(BaseCharacter character, PlayerAction action) {
