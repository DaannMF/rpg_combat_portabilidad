...
public abstract class BaseCharacter : MonoBehaviour {
    ...
    public event Action<BaseCharacter> OnCharacterDeath;
    public event Action<BaseCharacter, int> OnHealthChanged;
    ...
    public virtual bool CanAttack(BaseCharacter target) {
